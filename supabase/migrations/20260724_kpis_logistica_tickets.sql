-- KPIs públicos alineados con la capa operacional (tickets), no solo traslados legacy.
-- tiempo_promedio_horas = creación del ticket → primera asignación de transportista.
