-- Fix: "column t.telefono does not exist" al asignar recursos (Confirmar Despacho)
--
-- Causa: sync_ticket_changes_to_traslado() en prod aún hace
--   select t.nombre, t.telefono ... from transportes t
-- pero la columna correcta es contacto (no telefono).
--
-- Este script redeploya la función corregida (usa t.contacto / m.contacto).
