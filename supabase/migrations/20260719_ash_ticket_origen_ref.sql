-- Ash: guardar origen_ref además de destino_ref en tickets
...
begin
  ...
  loop
    ...
    insert into public.tickets (
      ...
      ref_text,
      coalesce((item->>'origen_lat')::double precision, (item->>'destino_lat')::double precision),
      coalesce((item->>'origen_lng')::double precision, (item->>'destino_lng')::double precision),
      ref_text,
