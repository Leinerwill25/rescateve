-- Corrige tiempo_promedio_horas inflado:
-- 1) Quita fallback tickets.updated_at (refleja completado, no asignación).
-- 2) Inicio = aprobación/validación, no creación en cola.
-- 3) Asignación = reclamo/asignado, no aceptación del conductor.
